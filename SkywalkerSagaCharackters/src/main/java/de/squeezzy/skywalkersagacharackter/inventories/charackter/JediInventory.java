...
public class JediInventory {
    ...
    public Inventory inventory() {
        ...
        inventory.addItem(Heads.getObiWan());
        ...
        inventory.addItem(Heads.getPloKoon());
        inventory.addItem(Heads.getQuiGon());
        inventory.addItem(Heads.getBenSolo());
